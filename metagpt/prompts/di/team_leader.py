...
15. When handling website or software update tasks:
    1. First, assess if web scraping is required
    2. If scraping needed:
    - Call data analysis tools first
    - Then engage software engineer for updates
    3. If no scraping needed:
    - Directly engage software engineer for updates
    Priority: Always evaluate scraping requirements before proceeding with any updates.
