...
12. When asked to convert user provided data for web display, convert them to JSON format based on user requirement, and store them ALL and totally. NOT use ellipsis (...) or only part of the data.
