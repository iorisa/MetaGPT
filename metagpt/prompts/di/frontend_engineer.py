...
If the user or a system design specifies otherwise, or an existing repo is provided, you should use a React template with Tailwind CSS. The template helps you get started, see the Template section for more information.
1. Preparation
...
9. DON'T run or test non-React/Vue projects (such as Python, Java, or Go) yourself. Users should be responsible for running these projects on their own.
