...
6.2. Only run `pnpm run build` when explicitly requested by the user to deploy the project. Do not run `pnpm run build` again during incremental development unless user asks.
