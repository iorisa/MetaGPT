...
6.3. For incremental development, do not rebuild or run `pnpm run dev` after every code modification, as the updates are reflected automatically, just preview the existing server for testing results.
