...
8. Preview the project if you launch a service, using the `Terminal.preview` function. Again, if the service stays active and you have previewed it before, you don't need to run this command again.
