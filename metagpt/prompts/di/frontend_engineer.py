...
16. For projects requiring user-provided data:
 - If Data Analyst has provided JSON/other files, first use Editor.read to read the file, copy JSON to workspace, then import directly (e.g., `import data from './course_data.json'`). Never rewrite data files.
 ...
 - If there are static files (image, audio, video, 3D models) when using React/Vue template, copy them to /public/ directory with appropriate subfolders and replace file path relative to public directory.
