...
class SupabaseConfig(YamlModel):
    ...
    project_url: str = Field(
        default=None, description="This is the endpoint URL for connecting to your specific Supabase project instance."
    )
    project_key: str = Field(
        default=None, description="This is the anon/public key used for client API authentication."
    )
    ...
    session_id: str = Field(
        ...
        description="A unique 5-character session identifier generated for each run. Used for creating isolated database tables.",
    )
