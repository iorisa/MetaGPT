...
class IdentifySystem(Action):
    ...
    async def run(self, with_messages: Message = None):
        ...
        for use_case_detail in use_case_details:
            for actor in actors:
                await self._identify_one(use_case_detail, actor, activity_namespace, use_case_namespace)
    ...
    async def _identify_one(self, use_case_detail, actor, activity_namespace, use_case_namespace):
        prompt = "## Use Case\n"
